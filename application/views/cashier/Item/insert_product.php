...
<!-- Insert Product Functionalities -->
        ...
        <div class="main-panel-content">
            ...
            <div class="card" id="sales-summary">
              <div class="title">
                ...
                <p class="subtitle">Add Product To The Branch Stock</p>
              </div>
              <div class="content">
                  ...
                  <div>
                    ...
                    <div class="table-responsive" id="printData_id">
                        ...
                        <table class="table table-bordered table-striped" id="grn_table">
                          ...
                          <td><input type="Number" name="qty_<?= $row->item_code; ?>" id="quentity1" min="0" required="true" ></td>
