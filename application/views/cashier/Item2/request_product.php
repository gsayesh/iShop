		...
		$(function(){
			...
			function load_data(query)
			{
				...
				$.ajax({
					...
					url:"<?php echo base_url(); ?>Cashier/search_product_request",
					method:"POST",
					data:{query:query},
			...
			$('#add_data').click(function(){
				...
				// Need change the variable names
				var basic_data = {
					'grn_no' : $('#grn_no').val(),
					'branch' : $('#branch').val(),
					'user' : $('#user').val()
				...
				if (table_data.length == 0) {
					...
					swal({
							...
							title : 'Do You Want Request Items From Main Stock?',
						...
						function(){
							...
							$.ajax({
								...
								data : data,
								type : 'POST',
								url : '<?php echo base_url('Cashier/request_item'); ?>',
								crossOrigin : false,
								dataType : 'json',
