    ...
    <div class="container-fluid">
	    ...
	    <div class="main-panel-content">
	        ...
	        <div class="card" id="sales-summary">
	          ...
	          <div class="content">
  	           <div class="row">
                   <div class="panel user col-md-3">
                    <a href="javascript:void();"><span>B1 </span>Matara</a>
                  </div>
                  <div class="panel user col-md-3">
                    <a href="javascript:void();"><span>B2 </span>Hakmana</a>
                  </div>
                  <div class="panel user col-md-3">
                    <a href="javascript:void();"><span>B3 </span>Walsmulla</a>
                  </div>
                  <div class="panel userAdd col-md-3">
                    <a href="javascript:void();"><span style="font-size: 110px;">+ </span>Add branch</a>
                  </div>
              </div>
	          </div>
	        </div>
